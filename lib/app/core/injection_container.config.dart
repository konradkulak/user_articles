...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i5.AuthorsRemoteRetrofitDataSource>(
        () => _i5.AuthorsRemoteRetrofitDataSource(gh<_i3.Dio>()));
    gh.factory<_i6.AuthorsRepository>(() => _i6.AuthorsRepository(
        remoteDataSource: gh<_i5.AuthorsRemoteRetrofitDataSource>()));
    ...
    gh.factory<_i8.HomeCubit>(
        () => _i8.HomeCubit(authorsRepository: gh<_i6.AuthorsRepository>()));
    gh.factory<_i9.ArticlesCubit>(() =>
        _i9.ArticlesCubit(articlesRepository: gh<_i7.ArticlesRepository>()));
    return this;
  }
}
